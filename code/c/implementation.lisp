...
(defun nan-literals-p (client)
  (and (member (client-standard client) '(:c99 :c11 :c17 :c23 :c++03 :c++11 :c++14
                                          :c++17 :c++20 :c++23 :c++26))
       t))
...
(quaviver:define-number-parser
  ...
  (:alternate? #\+
               (:sequence #\-
                          (:set :sign -1)))
  (:alternate (:sequence (:assert 'nan-literals-p)
                         (:assert :float t)
                         "inf"
                         (:sequence? "inity")
                         (:set :code :infinity
